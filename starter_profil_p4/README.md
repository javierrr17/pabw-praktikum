...
# PABW — Firstly Javierrazel Hermawan — 25523158
...
Topik halaman saya: Halaman profil pribadi dan portofolio.

- Arah visual: Tegas dan teknis (Presisi, serius, seperti dokumentasi)
- Warna utama: Navy hampir hitam (#0F172A) dan Teal (#0D9488) dari tema aset/dokumentasi pribadi
- Warna netral: Terang (#F8FAFC) & Gelap (#0F172A)
- Tautan navigasi: Tentang Saya, Karya, Kontak, Tanya Jawab, Keterampilan, Sedang Dikerjakan

## Catatan penggunaan AI

Penggunaan AI (Gemini) digunakan untuk membantu menyusun struktur dokumentasi README